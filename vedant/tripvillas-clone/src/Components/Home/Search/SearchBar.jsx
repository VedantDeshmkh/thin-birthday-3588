...
export default function SearchBar(){
    ...
    return(
        <>
        <Image position={'absolute'} m={'Auto'} w={'100%'} h='30rem' opacity={"70%"} src="https://d2v8elt324ukrb.cloudfront.net/static/new_template/media/Pimal2-1.2d5d237dbd32.jpg" alt="Tripvillas"/>
        <Box color={'white'} m={'auto'} w={'70%'} pt='10rem' position={'relative'}>
            ...
            <Box  p={'0 0 0 4rem'} fontSize={'2xl'} fontWeight={'800'} textAlign={'left'}  >Top Holiday Homes - Villas, Apartments & Homestays</Box>
                <Box bg={'white'} borderRadius={'5'} color={'blackAlpha.600'} h={'3rem'} p={'5px'} display={'flex'} w='100%' border={'1px solid lightgrey'}>
                <SearchIcon h={'40px'} /><Input w={'20%'} placeholder="Location"/>
                ...
                <select >
                    ...
                    <option value="8">10 Person</option>
                </select>
